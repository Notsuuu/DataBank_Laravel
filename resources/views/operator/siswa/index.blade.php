...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <!-- Form Pencarian & Filter Gabungan -->
        <div class="p-5 border-b border-slate-100 bg-white">
            <form action="{{ route('operator.siswa.index') }}" method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-3 items-end">
                ...
                <!-- Filter Kelas (Menggunakan tingkat_kelas) -->
                <div>
                        ...
                        <td class="px-6 py-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs font-semibold text-blue-600 mt-0.5">{{ $s->kelas->nama_kelas ?? 'Belum ada kelas' }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-3">

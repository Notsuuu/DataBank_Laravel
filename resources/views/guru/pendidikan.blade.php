...
@section('title', 'Riwayat Pendidikan - Panel Guru')
...
@section('content')
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('guru.pendidikan.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 px-4 rounded-lg text-sm shadow-sm flex items-center justify-center gap-2 transition-colors">
            ...
            <div class="relative border-l-2 border-slate-200 ml-3 md:ml-4 space-y-8">
                ...
                <div class="relative pl-8">
                    ...
                    <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-2">
                        <div>
                            <span class="inline-block px-2 py-1 mb-2 text-xs font-bold {{ $index === 0 ? 'text-emerald-700 bg-emerald-100' : 'text-slate-700 bg-slate-100' }} rounded-md">
                                {{ $riwayat->jenjang }}
                            </span>

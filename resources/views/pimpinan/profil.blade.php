...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <form action="{{ route('pimpinan.profil.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        ...
        <div class="lg:col-span-8">
            <form action="{{ route('pimpinan.profil.update') }}" method="POST" class="bg-white rounded-2xl shadow-sm shadow-slate-200/50 border border-slate-200/80 p-6 md:p-8">
                @csrf
                @method('PUT')

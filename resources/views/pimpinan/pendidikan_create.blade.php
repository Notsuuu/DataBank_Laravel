...
@section('title', 'Tambah Riwayat Pendidikan - Panel Pimpinan')
@section('header', 'Tambah Pendidikan')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm shadow-slate-200/50 border border-slate-200/80 overflow-hidden">
        <form action="{{ route('pimpinan.pendidikan.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun_lulus" required placeholder="Contoh: 2021" class="w-full rounded-xl border-slate-300 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700 placeholder:text-slate-400 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-100 transition-colors">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="institusi" required placeholder="Contoh: Universitas Tadulako" class="w-full rounded-xl border-slate-300 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700 placeholder:text-slate-400 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-100 transition-colors">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="jurusan" required placeholder="Contoh: Teknik Informatika" class="w-full rounded-xl border-slate-300 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700 placeholder:text-slate-400 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-100 transition-colors">
                    </div>
